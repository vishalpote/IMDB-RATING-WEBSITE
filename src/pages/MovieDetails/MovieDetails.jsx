...
// api_key="https://api.themoviedb.org/3/movie/${id}?api_key=0af9936fdd27cbb403e5cdddaba65172&language=en-US"
...
const MovieDetails = () => {
    ...
    const getData = () => {
        fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=0af9936fdd27cbb403e5cdddaba65172&language=en-US`)
        .then(res => res.json())
